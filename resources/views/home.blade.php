...
<div class="container">
    <div class="row  justify-content-center d-flex" >
        <div class="col-4 pt-5" >
            <div class="text-end">
                <img src="\jpg\profile.jpg" alt="" class="rounded-circle ms-5" style="height: 125px;">
            </div>
        </div>
        <div class="col-8 pt-5">
            <div><h1>NPC User</h1></div>
            <div class="d-flex">
            ...
            <div class="pt-4"><strong>Npcgram.org</strong></div>
            <div>Full stack developer developing Laravel app</div>
            <div><a href="#">www.mautgram.org</a></div>
        </div>
    </div>
    <div class="row pt-5">
        <div class="col-4">
